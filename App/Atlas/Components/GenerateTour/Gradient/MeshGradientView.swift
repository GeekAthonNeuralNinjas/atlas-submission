...
struct MeshGradientView: View {
    ...
    var body: some View {
        MeshGradient(width: 3, height: 3, points: [
            ...
            Color.init(hex: "1BA1E3"), Color.init(hex: "9B72CB"), .indigo,
            Color.init(hex: "D96570"), Color.init(hex: "F49C46"), Color.init(hex: "1BA1E3"),
            .indigo, Color.init(hex: "9B72CB"), Color.init(hex: "1BA1E3")
        ])
        .onAppear {
